...
i686-w64-mingw32-gcc $FLAGS -march=i686 -Wl,--major-subsystem-version,6 -Wl,--minor-subsystem-version,1 \
  -o "$OUT/SFCleaner_x86.exe" sfcleaner.c ml_feat.c ml_model.c ml_net.c /tmp/mf32.o -lwintrust -lcomctl32
...
x86_64-w64-mingw32-gcc $FLAGS -Wl,--major-subsystem-version,6 -Wl,--minor-subsystem-version,1 \
  -o "$OUT/SFCleaner_x64.exe" sfcleaner.c ml_feat.c ml_model.c ml_net.c /tmp/mf64.o -lwintrust -lcomctl32
